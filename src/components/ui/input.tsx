...
const placeVariants = cva(
  "absolute top-1/2 -translate-y-1/2 text-slatefor text-base px-3 py-[9px] lg:py-[5px] font-bold bg-slateone",
  {
    variants: {
      variant: {
